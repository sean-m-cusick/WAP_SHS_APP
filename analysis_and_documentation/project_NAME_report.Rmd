...
To increase our efficiency, we decided to choose a specific question for our topic, and 

We prioritised ...

### Data Groups

For the MVP, only data groups `00`, `01`, `02`, and `06` were used. These groups can be further divided as follows:  
