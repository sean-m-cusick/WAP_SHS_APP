...
* Interactivity of the Shiny App  
* check boxes of each health board  
...
Data Group 05 | COVID-19 Wider Impacts      
...
These groups can be further divided as follows:  

.csv file   | Data Set        | Data Group  
:---------- | :------------- | :-------------
"00_Clean_Dataframe_List" | 
"df_age_ane_hscp_ans" | 
"df_age_day_trend_ans" | 
"df_age_group_cov_hb_ans" | 
"df_age_group_cov_hscp_ans" | 
"df_age_group_ha_ans" | 
"df_age_sas_hb_ans" | 
"df_age_sas_hscp_ans" | 
"df_age_tot_cov_ans" | 
...
### Motivations
for using the data you have chosen
