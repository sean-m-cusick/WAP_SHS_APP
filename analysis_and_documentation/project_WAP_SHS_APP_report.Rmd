...
The cleaning script is then loaded into the datasets and run. Generic cleaning processes, such as removing redundant columns and creating a 'quarter' and 'year' column throughout most datasets, were then carried out.
The cleaned datasets were then output into the 'clean_script' folder for data analysis.

Additional cleaning may be required on individual datasets depending on each analysis' requirement.
