...
The wrangling process is focused on standarised any catagory and foreign key columns. Such as establish a "year" & "quarter" columns for each dataset, and reordering any age_group columns.
The output dataframes should have multiple foregin key columns ready to be process in the analysis stage.
