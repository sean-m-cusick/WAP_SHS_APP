...
ane_hb_ans_api = "388fd86c-dc0b-4655-b4b1-f13644bfd8d2"
# A&E Activity by Health Board and Deprivation
ane_hb_dep_api = "ec70ded6-9f45-4348-aaa9-b1b40ddae6a4"
# A&E Activity by HSCP, Age and Sex
ane_hscp_ans_api =  "a5677672-cc57-4b36-a884-84d6befd570f"
# A&E Activity by HSCP and Deprivation
ane_hscp_dep_api =  "39da7e8d-0ecf-41b7-aef1-cd898ba8b4fa"

# Data Group 04 - Bed Capacity
# Beds by Board of Treatment and Specialty
bed_info_api = "f272bb7d-5320-4491-84c1-614a2c064007"
...
sample_DF <- phs_df_func(bed_info_api)
view(sample_DF)
```
...
# Data Group 03 
# A&E Activity by Health Board, Age and Sex
backup_ane_hb_ans <- phs_df_func(ane_hb_ans_api)
# A&E Activity by Health Board and Deprivation
backup_ane_hb_dep <- phs_df_func(ane_hb_dep_api)
# A&E Activity by HSCP, Age and Sex
backup_ane_hscp_ans =  phs_df_func(ane_hscp_ans_api)
# A&E Activity by HSCP and Deprivation
backup_ane_hscp_dep =  phs_df_func(ane_hscp_dep_api)


# Data Group 04 - Bed Capacity
# Beds by Board of Treatment and Specialty
backup_bed_info = phs_df_func(bed_info_api)
